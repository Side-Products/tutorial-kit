...
| -------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Remotion and `@remotion/*` | [Remotion license and terms](https://www.remotion.dev/docs/license). Commercial use may require a separate license; this project's MIT license does not replace those terms. |
...
guide to direct dependencies, not a replacement for transitive dependency notices.

`examples/faceless/` references public Faceless pages. It includes no credentials, music, or voice recordings,
and does not grant rights to third-party branding. Configure a voice you have permission to use and provide
your own licensed music or logo. The local `examples/basic/` fixture is included under MIT.

OpenAI-compatible providers and ElevenLabs have separate account, billing, data processing, and content terms.
Check those terms when choosing a provider or publishing generated media.
